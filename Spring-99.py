                            ...
                            if D==1:
                                ...
                                if i==1:
                                    ...
                                    if compress_or_not_compress==1:
                                            ...
                                            Equal_info_between_of_the_cirlce_of_the_file_17=Equal_info_between_of_the_cirlce_of_the_file_17+add_bits4+Equal_info_between_of_the_cirlce_of_the_file_23+add_bits5+Equal_info_between_of_the_cirlce_of_the_file_24
                                    ...
                                    if   lenfS<=Deep3 or compress_or_not_compress==2:
                                            ...
                                            lenf_bytes_11=bin(lenf7)[2:]
                                            lenf=len(lenf_bytes_11)
                                    ...
                                    if   lenfS<=Deep3 or compress_or_not_compress==2:
                                            ...
                                            Equal_info_between_of_the_cirlce_of_the_file0=bin(Deep11)[2:]
                                    ...
                                    if   lenfS<=Deep3 or compress_or_not_compress==2:
                                            lenf=len(Equal_info_between_of_the_cirlce_of_the_file_17)                                           
                                            Equal_info_between_of_the_cirlce_of_the_file_17=add_bits10+lenf_bytes_11+add_bits9+Equal_info_between_of_the_cirlce_of_the_file1+add_bits8+Equal_info_between_of_the_cirlce_of_the_file0+add_bits7+Equal_info_between_of_the_cirlce_of_the_file_29+add_bits+Equal_info_between_of_the_cirlce_of_the_file_17
                                ...
                                if i==2:
                                    ...
                                    if C==1:
                                        if   Circle_times2==0:
                                                ...
                                                lenf11_long=Equal_info_between_of_the_cirlce_of_the_file[0:32]
                                                lenf11 = int(lenf11_long, 2)
                                                lenf11=lenf11*8
                                        ...
                                        if C==1 and T!=0:
                                                        ...
                                                        Number_add_plus_one1=Equal_info_between_of_the_cirlce_of_the_file[lenf6-Deep20:lenf6]
                                    ...
                                    if i==2:
                                        ...
                                        if  Circle_times2==T:
                                            ...
                                            if C==1 and T!=0:
                                            	...
                                            	#print(lenf14)
                                            	lenf16=lenf14%8
                                            	if lenf16!=0 or lenf14>=((2**32)-1)*8 or Corrupted==1 or lenf11==0 or lenf14!=lenf11 or lenf14==0 or Bit_1!="1":
